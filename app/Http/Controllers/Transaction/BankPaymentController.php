...
//
    ...
    public function saveBPTrans(Request $request)
    {
...
//            $fpno = Carbon::createFromFormat('d/m/Y', $request->input('transDate'))->format('m');
        ...
        return redirect()->action('Transaction\BankPaymentController@index');
