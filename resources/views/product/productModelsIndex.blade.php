...
@section('content')
    ...
    <div class="col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1">
        <div class="well text-center" style="height: 50%; background-color: #f0f0ef">
            <p><strong>ADD EDIT UPDATE DELETE PRODUCT MODELS</strong></p>
        </div>
    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/product.model.new') }}">
                        {{ csrf_field() }}

                        <div class="form-group{{ $errors->has('modelNo') ? ' has-error' : '' }}">
                            <label for="modelNo" class="col-md-4 control-label">Product Model</label>

                            <div class="col-md-6">
                                <input id="modelNo" type="text" class="form-control" name="modelNo" value="" required autofocus>
