...
@section('content')
    ...
    <div class="col-sm-10 text-left col-sm-offset-1">
        ...
        {!! Form::open(['url'=>'sales.create.invoice']) !!}
        {{ csrf_field() }}

        <table class="table table-sm table-responsive">
            <tbody>
            <tr>
                <td><label for="relationship_id" class="control-label">Customers</label></td>
                ...
                <td><label for="invoicedate" class="control-label">Date</label></td>
                <td>{!! Form::text('invoicedate', \Carbon\Carbon::now()->format('d/m/Y') , array('id' => 'invoicedate', 'class' => 'form-control','required','readonly')) !!}</td>
                <td align="right"><label for="invoiceno" class="control-label">Invoice No</label></td>
                <td align="right">{!! Form::text('invoiceno','SI'.$invoicenumber , array('id' => 'invoiceno', 'class' => 'form-control')) !!}</td>
            </tr>
            <tr>
                <td><label for="paid_amt" class="control-label">Payment</label></td>
                <td>{!! Form::text('paid_amt', null , array('id' => 'paid_amt', 'class' => 'form-control text-right')) !!}</td>
            ...
            <div class="table-responsive">
                <table class="table table-bordered" id="items">
                    ...
                    <tr id="item-row-{{ $item_row }}">
                        ...
                        <td>
                            {!! Form::select('item[' . $item_row . '][tax]',(['' => 'Please Select'] + $taxes) , null, ['id'=> 'item-tax-'. $item_row, 'class' => 'form-control','onfocus'=>'this.select();',  'placeholder' => trans('general.form.select.field', ['field' => trans_choice('general.taxes', 1)])]) !!}
                        </td>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        var autocomplete_path = "{{ url('itemautocomplete') }}";
